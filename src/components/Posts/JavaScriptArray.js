  ...
  return (
    <Wrapper>
      ...
      <Container>
        ...
        <Spacer />
        <Text>
          Do you ever find yourself forgetting what function would be best to manipulate your data?
          ...
          <li>JavaScript arrays are zero-indexed, which means they start at index 0, the second index being 1 and so forth. If you're wanting to get the last element of the array - you can always get the length of the array minus 1</li>
          <CodeBlock>
            const starWarsCharacters = [];
            <Spacer />
            starWarsCharacters.push("Luke", "Leia", "Han");
            <Spacer />
            console.log(starWarsCharacters.length); // 3
          </CodeBlock>
        </Text>
      </Container>
    </Wrapper>
