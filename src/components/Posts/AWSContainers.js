...
const AWSContainers = () => {
  ...
  useEffect(() => {
    if (window.location.hostname !== "localhost") {
      ReactGA.pageview('/blog/aws-containers');
    }
  }, []);
    ...
    <Wrapper>
      ...
      <Container>
        ...
        <Text>
          ...
          <StyledAnchor href="#data-volumes"><StyledListItem>ECS - Data Volumes (EFS)</StyledListItem></StyledAnchor>
          ...
          <SubTitle id="data-volumes">ECS - Data Volumes (EFS)</SubTitle>
